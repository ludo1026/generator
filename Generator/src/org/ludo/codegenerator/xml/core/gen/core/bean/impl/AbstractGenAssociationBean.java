...
public class AbstractGenAssociationBean implements GenAssociation {
    ...
    private List<GenAssociationAttribute> listeGenAssociationAttribute = new ArrayList<GenAssociationAttribute>();
	
    public GenAssociationAttribute getGenAssociationAttributeByGenId(String genId) {
        for(GenAssociationAttribute genAssociationAttribute : listeGenAssociationAttribute) {
            if(genAssociationAttribute.getGenId().equalsIgnoreCase(genId)) {
                return genAssociationAttribute;
            }
        }
        throw new IllegalStateException("La genAssociationAttribute n'est pas définie : genId de genAssociationAttribute = "+genId);
    }
    public void addGenAssociationAttribute(GenAssociationAttribute genAssociationAttribute) {
    	genAssociationAttribute.setReferenceGenAssociation(this);
        listeGenAssociationAttribute.add(genAssociationAttribute);
    }
    public List<GenAssociationAttribute> getListeGenAssociationAttribute() {
        return listeGenAssociationAttribute;
    }
    public void setListeGenAssociationAttribute(List<GenAssociationAttribute> listeGenAssociationAttribute) {
        this.listeGenAssociationAttribute = listeGenAssociationAttribute;
    }
