...
public class AbstractGenAttributBean implements GenAttribut {
    ...
    public GenProprietesAttribut getGenProprietesAttribut() {
    	return this.genProprietesAttribut;
    }
    
    public void setGenProprietesAttribut(GenProprietesAttribut genProprietesAttribut) {
    	genProprietesAttribut.setReferenceGenAttribut(this);
    ...
    public GenStereotypesAttributRef getGenStereotypesAttributRef() {
    	return this.genStereotypesAttributRef;
    }
    
    public void setGenStereotypesAttributRef(GenStereotypesAttributRef genStereotypesAttributRef) {
    	genStereotypesAttributRef.setReferenceGenAttribut(this);
