...
public class AbstractGenMethodeBean implements GenMethode {
    ...
    public GenProprietesMethode getGenProprietesMethode() {
    	return this.genProprietesMethode;
    }
    
    public void setGenProprietesMethode(GenProprietesMethode genProprietesMethode) {
    	genProprietesMethode.setReferenceGenMethode(this);
