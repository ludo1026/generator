...
public final class AssertHelper {
	...
	public static void assertNotNullArgument(Object param, String nomParam, String nomMethode) {
		if( param == null ) {
			throw new NullArgumentException(nomMethode+" : L'argument '"+nomParam+"' n'est pas d̩fini.");
		}
	}
	
	public static void assertNotNullArgument(Object param, String nomParam) {
		if( param == null ) {
			throw new NullArgumentException("L'argument '"+nomParam+"' n'est pas d̩fini.");
		}
	}
	
	public static void assertNotNull(Object param, String nomParam) {
		if( param == null ) {
			throw new IllegalStateException("L'objet '"+nomParam+"' n'est pas d̩fini.");
		}
	}
	...
	public static void assertDefined(Object param, String nomParam) {
		if( param == null ) {
			throw new IllegalStateException("La valeur '"+nomParam+"' n'est pas d̩finie.");
		}
		else
		...
		if( param instanceof java.util.List ) {
			if( ((List)param).isEmpty() ) {
				throw new IllegalStateException("La liste '"+nomParam+"' n'est pas d̩finie.");
			}
			return;
		}
	}
    ...
    public static void assertDefinedArgument(Object param, String nomParam, String nomMethode) {
        if( param == null ) {
            throw new IllegalArgumentException(nomMethode+" : La valeur '"+nomParam+"' n'est pas d̩finie.");
        }
        else
        if( param instanceof java.lang.String ) {
            if( StringUtils.isEmpty((java.lang.String)param) ) {
        ...
        if( param instanceof java.util.List ) {
            if( ((List)param).isEmpty() ) {
                throw new IllegalArgumentException(nomMethode+" : La liste '"+nomParam+"' n'est pas d̩finie.");
            }
            return;
        }
    }
