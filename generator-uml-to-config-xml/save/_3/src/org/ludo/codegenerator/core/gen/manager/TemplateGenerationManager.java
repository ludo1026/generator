...
public class TemplateGenerationManager {
	...
	private final BeanTemplateManager beanTemplateManager;
	private final BeanTemplateReferentielManager beanTemplateReferentielManager;
						...
						)
	{
		...
		this.beanTemplateManager = new BeanTemplateManager(gen, listeTemplateGeneration);
		this.beanTemplateReferentielManager = new BeanTemplateReferentielManager();
	}
	...
	public BeanTemplateManager getBeanTemplateManager() {
		return beanTemplateManager;
	}
	...
	public BeanTemplateReferentielManager getBeanTemplateReferentielManager() {
		return beanTemplateReferentielManager;
	}
